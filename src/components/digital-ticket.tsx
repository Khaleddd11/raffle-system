  ...
  return (
    <div className="flex w-full flex-col items-center gap-4">
      <div className="relative w-full max-w-sm">
        <div
          ref={ticketRef}
          className="relative overflow-hidden rounded-tl-3xl rounded-tr-3xl rounded-b-none bg-white px-4 pt-4 pb-10 text-foreground shadow-md before:absolute before:top-1/2 before:-left-3 before:h-6 before:w-6 before:-translate-y-1/2 before:rounded-full before:bg-muted after:absolute after:top-1/2 after:-right-3 after:h-6 after:w-6 after:-translate-y-1/2 after:rounded-full after:bg-muted"
          style={{
            maskImage:
              "radial-gradient(circle at 5% 100%, transparent 14px, black 14px), radial-gradient(circle at 12% 100%, transparent 14px, black 14px), radial-gradient(circle at 19% 100%, transparent 14px, black 14px), radial-gradient(circle at 26% 100%, transparent 14px, black 14px), radial-gradient(circle at 33% 100%, transparent 14px, black 14px), radial-gradient(circle at 40% 100%, transparent 14px, black 14px), radial-gradient(circle at 47% 100%, transparent 14px, black 14px), radial-gradient(circle at 54% 100%, transparent 14px, black 14px), radial-gradient(circle at 61% 100%, transparent 14px, black 14px), radial-gradient(circle at 68% 100%, transparent 14px, black 14px), radial-gradient(circle at 75% 100%, transparent 14px, black 14px), radial-gradient(circle at 82% 100%, transparent 14px, black 14px), radial-gradient(circle at 89% 100%, transparent 14px, black 14px), radial-gradient(circle at 95% 100%, transparent 14px, black 14px)",
            WebkitMaskImage:
              "radial-gradient(circle at 5% 100%, transparent 14px, black 14px), radial-gradient(circle at 12% 100%, transparent 14px, black 14px), radial-gradient(circle at 19% 100%, transparent 14px, black 14px), radial-gradient(circle at 26% 100%, transparent 14px, black 14px), radial-gradient(circle at 33% 100%, transparent 14px, black 14px), radial-gradient(circle at 40% 100%, transparent 14px, black 14px), radial-gradient(circle at 47% 100%, transparent 14px, black 14px), radial-gradient(circle at 54% 100%, transparent 14px, black 14px), radial-gradient(circle at 61% 100%, transparent 14px, black 14px), radial-gradient(circle at 68% 100%, transparent 14px, black 14px), radial-gradient(circle at 75% 100%, transparent 14px, black 14px), radial-gradient(circle at 82% 100%, transparent 14px, black 14px), radial-gradient(circle at 89% 100%, transparent 14px, black 14px), radial-gradient(circle at 95% 100%, transparent 14px, black 14px)",
